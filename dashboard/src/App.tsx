...
import { Fixture, TeamStrength, TeamRaw, Player } from "./data/types";
...
export default function App() {
  ...
  const [teamsStrength, setTeamsStrength] = useState<TeamStrength[]>([]);
  const [teamsRaw, setTeamsRaw] = useState<TeamRaw[]>([]);
  ...
  const renderActiveView = () => {
    switch (activeView) {
      ...
      case "processed":
        return <ProcessedView selectedSeason={selectedSeason} selectedGW={selectedGW} />;
      case "players":
