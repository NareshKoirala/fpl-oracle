...
Serves as the local dataset layer modeling Premier League inputs:
*   **`types.ts`** – Central definitions, interfaces, and schemas for players, fixtures, and standings.
*   **`all_data_structure.ts`** – Static season-to-gameweek indices.
